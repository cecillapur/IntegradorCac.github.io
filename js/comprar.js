...
botonBorrar.addEventListener("click", function() {
    pmensajeApellido.remove("mensajeApellido");
    pmensajeNombre.remove("mensajeNombre");
    pmensajeEmail.remove("mensajeEmail");
    pmensajeCantidad.remove("mensajeCantidad");
    pmensajeCategoria.remove("mensajeCategoria");
    totalPago.remove("total_a_pagar");
